...
function vis6() {
      ...
      // Tomo el svg
      const svg = d3.select("#preflow-levels")
            .attr("width", WIDTH)
            .attr("height", HEIGHT)
      ...
      async function loop() {
            while (true) {
                  ...
                  change_color(1, 1);
                  change_color(2, 1);
                  change_opacity(0, 1, 0);
                  change_opacity(0, 2, 0);
                  change_opacity(1, 0, 1);
                  change_opacity(2, 0, 1);
                  await sleep(3000);
                  move_node_instant(3, 0);
                  move_node_instant(2, 0);
                  move_node_instant(1, 0);
                  move_node_instant(0, 0);
                  change_color_instant(1, 0);
                  change_color_instant(2, 0);
                  change_opacity_instant(0, 1, 1);
                  change_opacity_instant(0, 2, 1);
                  change_opacity_instant(1, 0, 0);
                  change_opacity_instant(2, 0, 0);
            }
      }
      loop();
}
